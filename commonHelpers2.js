import{i as d}from"./assets/scrollUp-9d56be72.js";import{a as h}from"./assets/vendor-2bc536cc.js";const u=document.querySelector(".pages-list"),g=document.querySelector(".pages-btn-left"),f=document.querySelector(".pages-btn-right");u.addEventListener("click",U);g.addEventListener("click",W);f.addEventListener("click",F);function W(){const t=b();t.page!==1&&(t.page--,p(t),y())}function F(){const t=b();t.page>=localStorage.getItem(c.totalPages)||(t.page++,p(t),y())}function U(t){const e=+t.target.textContent;if(Number.isNaN(e))return;const a=b();a.page=e,p(a),y()}function G(t,e){let a=[];for(let s=1;s<=t;s++)a.push(s);if(t<=5){const s=a.map(i=>`<li class="pages-item is-hover">${i}</li>`).join("");u.innerHTML=s}else if(t>5){if(e<=2||e>t-2){const s=t-4;a.splice(2,s,"...");const i=a.map(o=>+o?`<li class="pages-item is-hover">${o}</li>`:`<li class="pages-item" disabled>${o}</li>`).join("");u.innerHTML=i}else if(e>2){const s=t-2;a.splice(1,s,"...",e,"...");const i=a.map(o=>+o?`<li class="pages-item is-hover">${o}</li>`:`<li class="pages-item" disabled>${o}</li>`).join("");u.innerHTML=i}}e!==1&&g.hasAttribute("disabled")&&(g.disabled=!1,g.classList.add("is-hover")),e!==t&&f.hasAttribute("disabled")&&(f.disabled=!1,f.classList.add("is-hover")),e===1&&!g.hasAttribute("disabled")&&(g.disabled=!0,g.classList.remove("is-hover")),e===t&&!f.hasAttribute("disabled")&&(f.disabled=!0,f.classList.remove("is-hover"));for(let s=0;s<u.children.length;s++)u.children[s].textContent==e?u.children[s].classList.add("current-pages-item"):u.children[s].classList.remove("current-pages-item")}const q="/js_93_SerhiiOberemchuk/assets/discount-ed7c6afc.jpg";h.defaults.baseURL="https://food-boutique.b.goit.study/api";const B={keyword:null,category:null,byABC:!0,byPrice:null,byPopularity:null,page:1,limit:j()},L={basic:"/products",popular:"/products/popular",discount:"/products/discount",categories:"/products/categories"},c={basic:"basic-wrapper",basket:"BASKET",popular:"popular-wrapper",discount:"discount-wrapper",totalPages:"totalPages",categories:"categories",axiosOptions:"axiosOptions"},n={form:document.querySelector(".filter_form"),products:document.querySelector(".products"),notFound:document.querySelector(".not-found-wrapper"),basicList:document.querySelector(".basic-list"),popularList:document.querySelector(".popular-list"),discountList:document.querySelector(".discount-list"),pagesWrapper:document.querySelector(".pages-wrapper"),categoriesSelector:document.querySelector("#categories"),sortSelector:document.querySelector("#sort"),pagesList:document.querySelector(".pages-list"),pagesBtnLeft:document.querySelector(".pages-btn-left"),pagesBtnRight:document.querySelector(".pages-btn-right")},w=`<div class="discount-label"> 
    ...
    </button>`;ct.innerHTML=e}function D(t){t.target===$&&A()}function z(t){t.key==="Escape"&&A()}function A(){$.style.display="none",$.removeEventListener("click",D),document.removeEventListener("keydown",z)}
